...
<HEAD>
	...
	<link rel="stylesheet" type="text/css" href="LittleHope_stil.css">
		...
		<div id="Naslov"><p>WISHES - EVENTS</p></div>
		<div id="Novosti">
            ...
            $rezultat = $veza->query("select id, Naslov, Tekst, Autor,DetaljnijiTekst,Slika, Datum from novosti where kategorija='wishes_events'");
            if (!$rezultat) {
            }
