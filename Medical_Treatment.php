...
<HEAD>
	...
	<link rel="stylesheet" type="text/css" href="LittleHope_stil.css">
		...
		<div id="Naslov"><p>MEDICAL - TREATMENT</p></div>
		<div id="Novosti">
			<?php
            ...
            $rezultat = $veza->query("select id, Naslov, Tekst, Autor,DetaljnijiTekst,Slika, Datum from novosti where kategorija='medical_treatment'");
            if (!$rezultat) {
            }
