...
<HEAD>
	...
	<link rel="stylesheet" type="text/css" href="LittleHope_stil.css">
		...
		<div id="Naslov"><p>EDUCATION - SCHOLARSHIP</p></div>
		<div id="Novosti">
<?php
            ...
            $rezultat = $veza->query("select id, Naslov, Tekst, Autor,DetaljnijiTekst,Slika, Datum from novosti where kategorija='education_scholarship'");
            if (!$rezultat) {
            }
