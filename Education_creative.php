...
<div id="Naslov"><p>EDUCATION - CREATIVE</p></div>
		<div id="Novosti">
            ...
            $rezultat = $veza->query("select id, Naslov, Tekst, Autor,DetaljnijiTekst,Slika, Datum from novosti where kategorija='education_creative'");
            if (!$rezultat) {
            }
